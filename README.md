...
# 个人介绍  
## 主要成就
*第二十三届资阳市青少年科技创新大赛二等奖*  
*第三十七届四川省青少年科技创新大赛一等奖*  
  
## 早期经历
我叫*倪繁发*，我是05后，很小的时候就对计算机十分痴迷，直到小学五年级才有了自己的第一台计算机，一台 HP Compaq 6005 Pro。那个时候我对操作系统也很感兴趣，经常购买盗版 Windows 光盘来安装操作系统。如果觉得 Windows 7 用腻了，我就会切换到 Windows XP。当时我装过最离谱的系统是中标麒麟系统，那也是我第一次接触 Linux 操作系统。不过装好之后发现 Linux 上的软件很少（应该说几乎没有桌面软件），结果我不知道怎么切换回 Windows。这让我对 Linux 桌面系统的第一印象很差，现在也是这样。
...
因此，基本上 Cosmos 无法使用。后来，我了解到了另一个由美国人 Phill Garcia 主导的 C# 操作系统套件，名为 MOSA（Managed Operating System Alliance）。与 Cosmos 相比，MOSA 的性能明显更高。它直接将代码编译为二进制机器码，而不是像 Cosmos 那样先将 IL2CPU 编译为文本文件，再交给汇编编译器处理。
...
计算机领域的学习确实让我受益匪浅，但也不可否认，它也耽搁了我的其他学业。或许这与我们所在的小县城教育资源有关。我曾就读于一所普通班的高中，班级里有 60 多人，但只有 5 个人能通过高考，甚至仅仅过了本科线。虽然我努力学习，但似乎并没有取得明显的进步，或许这就是现实吧。  
  
我这已经是大专开局了，学历这方面我也只能尽己所能弥补了。  
2024年7月3日
